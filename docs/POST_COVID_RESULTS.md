...
- **GOOGL**: From profit to WORST LOSS (-$8,302)
- **AAPL/MSFT**: Still profitable but 70-75% lower returns

### 2. **ETFs Became More Reliable**
- **SPY**: Actually IMPROVED (+19% better performance)
- **QQQ**: Held steady (only -19% drop)
- **ETFs showed more stability in volatile markets**

### 3. **Market Conditions Matter**
- **2015-2019**: Bull market, clear trends → Individual stocks thrived
- **2022-2024**: Volatile recovery, rate hikes → ETFs safer

### 4. **Win Rates Dropped Across the Board**
- Pre-COVID avg: 53%
- Post-COVID avg: 44%
- **More choppy markets = more whipsaws**
...
**Pre-COVID (2015-2019):**
- Clear uptrend ($300 → $1,800)
- 61.5% win rate
- Best performer

**Post-COVID (2022-2024):**
- Massive volatility
- COVID spike → crash → recovery
- Interest rate uncertainty
- **MA Crossover got whipsawed**

### Google (GOOGL) - Worst Performer

**Issues:**
- AI uncertainty (ChatGPT threat)
- Antitrust concerns
- Ad revenue volatility
- **More sideways action = more losses**

### SPY - The Winner

**Why it won:**
- Diversified (500 stocks)
- Less volatility than individual stocks
- Smoother trends
- **62.5% win rate** (highest!)
...
- **GOOGL only loser** (avoid!)
- **SPY most consistent** (profitable in both periods)
...
**Original plan** (based on pre-COVID only):
- Trade AMZN (best performer 2015-2019)
...
```bash
# Test on paper account first (free)
python run.py --config configs/ma_crossover_SPY.json --dry-run
```

### **Phase 2: Go Live with Small Capital**
- Start with $1,000-$2,000
- Trade SPY only
- Monitor for 1 month

### **Phase 3: Scale If Consistent**
- If matches replay results
...
- **Bull market (2015-2019)**: Individual stocks dominated
